...
const PAGES = [
  ...
  },
  {
    ...
    lines: [
      ...
      "[NEXT]    Star Credit caches in the Requisition Depot (kind: credits):",
      "          500-cache at $4.99, 1,200-cache at $9.99, 2,600-cache at",
      "          $19.99. Face value granted exactly at fulfillment.",
