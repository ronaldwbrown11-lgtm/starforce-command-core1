...
Site owners: see [`ADMIN-GUIDE.md`](./ADMIN-GUIDE.md) — a plain-language guide to
where your data lives, how to administer the site (Operator Console + Convex
dashboard), and how changes reach the live site. Technical deployment details
